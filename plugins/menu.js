      ...
      try {
         ...
         if (style === 1) {
            ...
            client.sendMessageModify(m.chat, Func.Styles(print) + '\n\n' + global.footer, m, {
               ads: false,
                title : `© BotShin - v6.0 | @botshin_`,
               body: `The First KPOP Theme Bot by MOSY`,
               largeThumb: true,
            ...
            if (text) {
               ...
               body: `The First KPOP Theme Bot by MOSY`,
                ...
                client.sendFile(m.chat, './media/audio/ujin.mp3', '', '', m, {
   ptt: true
})
            }
         }
