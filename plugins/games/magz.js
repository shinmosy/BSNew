...
exports.run = {
   ...
   async: async (m, {
      ...
      try {
         if (global.db.users.find(v => v.jid == m.sender).point < 10000) return client.reply(m.chat, Func.texted('bold', `🚩 Point yang kamu miliki tidak cukup untuk bermain game Sambung Kata.`), m)
...
➠ Untuk memainkan permainan ini dibutuhkan point sebanyak 10.000 point.
